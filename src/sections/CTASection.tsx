...
const CTASection = () => {
  return (
    <section className="px-10 py-20">
      <div className="max-w-7xl mx-auto relative overflow-hidden rounded-[48px] bg-transparent sm:bg-[#111] border-none sm:border border-white/5 p-12 md:p-24 flex flex-col items-center text-center">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-3xl sm:text-5xl md:text-7xl font-bold tracking-tight mb-8 text-white leading-[1.1]">
          ...
          <p className="text-sm sm:text-xl text-[#ffffff50] max-w-2xl mx-auto mb-12 font-light leading-relaxed">
