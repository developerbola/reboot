...
const Navbar = () => {
  return (
    <nav className="fixed top-0 z-50 w-full flex items-center justify-center gap-50 bg-[#0a0a0a] border-b border-[#ffffff05] h-15">
        ...
        {[
          ...
          <li key={item.name}>
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  "font-light text-sm transition-colors duration-200",
                  isActive
                    ? "text-blue-400"
                    : "text-[#ffffff90] hover:text-white"
                )
              }
            >
              {item.name}
